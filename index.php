...
<head>
	<title>Tri Mulyo news portal</title>
	...
	<link rel="shortcut icon" type="image/png" media="screen" href="gambar/tri.jpg" />
...
<body>
	<div id="container">
		<div id="header">
			<b>Tri newsp<i class="fa fa-compass"></i>rtal</b>
...
//taruh skrip 6 halaman index.php
 ...
 include "tampilan/beritapopuler.php";
  ?>
	...
	<div id="footer">
		&copy; 2020 Tri Mulyo Portal Berita
	</div>
